...
public class Updater {
	...
	private int id = 50092; // Project's Curse ID
	private String apiKey = "8a873e89fcaf3189b55e0b05adc8ac70136ccd00"; // BukkitDev ServerMods API key
	...
	private UpdateResult result = UpdateResult.SUCCESS; // Used for determining
														// the outcome of the
														// update process
	...
	public Updater(Plugin plugin, int id, File file, UpdateType type,
		...
		this.config.addDefault("api-key", "8a873e89fcaf3189b55e0b05adc8ac70136ccd00");
